#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Script to create all frontend files."""
...
<body>
    <div class="container">
        ...
        <div class="tabs">
            <button class="tab-button active" onclick="showTab('parts', event)">Parts</button>
            <button class="tab-button" onclick="showTab('builds', event)">Builds</button>
